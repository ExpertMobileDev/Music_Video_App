...
extern NSString *const PlayerViewControllerFullscreenEnter;
extern NSString *const PlayerViewControllerFullscreenExit;
extern NSString *const PlayerViewControllerInlineViewVisible;
extern NSString *const PlayerViewControllerFullscreenViewVisible;
 ...
 */
@interface PlayerViewController : OOOoyalaPlayerViewController


@property (nonatomic, readonly) OOOoyalaPlayerControlType initialControlType; // initial state
@property (nonatomic, strong) EdgeOOPlayer *player;
 ...
 */
- (id)initWithPlayer:(EdgeOOPlayer *)player;
