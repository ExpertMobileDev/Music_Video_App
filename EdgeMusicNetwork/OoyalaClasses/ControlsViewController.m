...
@interface UnselectableActivityIndicatorView : UIActivityIndicatorView
@end

@implementation UnselectableActivityIndicatorView
...
@interface ControlsViewController() {
  ...
  __unsafe_unretained EdgeOOPlayer *_player;
...
- (id) initWithControlsType:(OOOoyalaPlayerControlType)controlsType player:(EdgeOOPlayer *)player  overlay:(UIView *) overlay delegate:(id)dele{
  self = [self init];
...
- (void)viewDidLoad {
  ...
  //init activity view
  self.activityView = [[UnselectableActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
...
- (void) setPlayer:(EdgeOOPlayer *)player {
  [self removeObservers];
  _player = player;
